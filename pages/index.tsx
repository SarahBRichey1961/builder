        ...
        <section className="max-w-7xl mx-auto px-4 py-16">
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              ...
              <p className="text-xl text-slate-300 mb-6">unemployment
</p>
          ...
          <section className="mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-slate-800 border border-slate-700 rounded-lg p-6">
                  ...
                  <p className="text-slate-400">Task 1: Set up basic front-end structure with HTML/CSS</p>
                </div>
                <div className="bg-slate-800 border border-slate-700 rounded-lg p-6">
                  <div className="text-4xl mb-3">⚡</div>
                  <p className="text-slate-400">Task 2: Implement user input form for Step 1</p>
                </div>
            </div>
          </section>
        </section>
